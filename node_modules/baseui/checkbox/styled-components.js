...
const Toggle = exports.Toggle = (0, _styles.styled)('div', props => {
  ...
  return {
    ...
    boxShadow: props.$isFocusVisible ? `0 0 0 3px ${props.$theme.colors.borderAccent}` : props.$isHovered && !props.$disabled ? props.$theme.lighting.shadow500 : props.$theme.lighting.shadow400,
    outline: 'none',
